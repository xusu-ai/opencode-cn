      ...
      <box paddingLeft={4} paddingRight={4}>
        ...
        <box paddingTop={1}>
          <input
            ...
            placeholder={props.placeholder ?? t("tui.dialogSelect.searchPlaceholder")}
      ...
      <Show
        ...
        fallback={
          <box paddingLeft={4} paddingRight={4} paddingTop={1}>
            <text fg={theme.textMuted}>{t("tui.dialogSelect.noResultsFound")}</text>
          </box>
        }
      >
        <scrollbox
