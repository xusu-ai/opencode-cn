    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box gap={1}>
        ...
        <textarea
          ...
          placeholder={t("tui.export.filenamePlaceholder")}
      ...
      <box flexDirection="column">
        ...
        >
          ...
          <text fg={store.active === "thinking" ? theme.primary : theme.text}>{t("tui.export.includeThinking")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "toolDetails" ? theme.primary : theme.text}>{t("tui.export.includeToolDetails")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "assistantMetadata" ? theme.primary : theme.text}>{t("tui.export.includeAssistantMetadata")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "openWithoutSaving" ? theme.primary : theme.text}>{t("tui.export.openWithoutSaving")}</text>
        </box>
      </box>
      <Show when={store.active !== "filename"}>
        <text fg={theme.textMuted} paddingBottom={1}>
          {t("tui.export.toggleHint")}
        </text>
      </Show>
      <Show when={store.active === "filename"}>
        <text fg={theme.textMuted} paddingBottom={1}>
          {t("tui.export.confirmHint")}
        </text>
      </Show>
    </box>
  )
