      ...
      <DialogSessionDeleteFailed
        ...
        onDelete={async () => {
          ...
          if (result.error) {
            toast.show({
              variant: "error",
              title: t("tui.session.deleteWorkspaceFailed"),
      ...
      keybind={[
        {
          ...
          onTrigger: async (option) => {
            if (toDelete() === option.value) {
              ...
              try {
                ...
                if (result.error) {
                  if (session?.workspaceID) {
                    ...
                    toast.show({
                      variant: "error",
                      title: t("tui.session.deleteFailed"),
                      message: errorMessage(result.error),
                    })
                  }
                  setToDelete(undefined)
              ...
              // Navigate away if we deleted the currently active session
        ...
        },
        {
          ...
          title: t("tui.session.newWorkspace"),
          side: "right",
