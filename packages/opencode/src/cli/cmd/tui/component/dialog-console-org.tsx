...
export function DialogConsoleOrg() {
  ...
  const options = createMemo(() => {
    ...
    if (listed === undefined) {
      return [
        {
          title: t("tui.consoleOrg.loadingOrgs"),
          value: "loading",
          onSelect: () => {},
        },
      ]
    ...
    if (listed.length === 0) {
      return [
        {
          title: t("tui.consoleOrg.noOrgsFound"),
          value: "empty",
          onSelect: () => {},
        },
      ]
  ...
  return <DialogSelect<string | OrgOption> title={t("tui.consoleOrg.title")} options={options()} current={current()} />
}
