...
// Security note: API key is passed via URL query parameter because Exa MCP
// requires this format. This is a known risk — the key may appear in logs/proxy histories.
// Mitigation: only use EXA_API_KEY in trusted network environments.
// TODO: Request Exa to support header-based authentication (Authorization: Bearer ...)
