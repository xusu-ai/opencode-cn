...
export namespace AppFileSystem {
  ...
  export function contains(parent: string, child: string) {
    // Security: Resolve both paths to normalize .. segments before comparison.
    // This prevents string-based path traversal where unnormalized paths bypass the check.
